namespace Xamarin.Forms.Labs.Validation
{
    ...
    public class Rule : BindableObject
    {
        ...
        private static readonly List<UserValidator> _userValidatorPredicates = new List<UserValidator>();
        ...
        /// <summary>Adds a user supplied validator to the list of availble validators.</summary>
        ...
        public static void AddValidator(string name, Func<Rule, string, bool> predicate)
        {
            ...
            _userValidatorPredicates.RemoveAll(x => string.Compare(x.UserName, name, StringComparison.OrdinalIgnoreCase) == 0);
            _userValidatorPredicates.Add(v);
        }
