...
namespace Xamarin.Forms.Labs.iOS.Controls
{
    public class DynamicUITableViewRenderer<T> : ViewRenderer<DynamicListView<T>, UITableView>
    {
        ...
        {
            this.Element.InvokeItemSelectedEvent(tableView, this.Element.Data[(int)indexPath.Item]);
        }

        //[Export("tableView:heightForRowAtIndexPath:")]
        public virtual float GetHeightForRow(UITableView tableView, NSIndexPath indexPath)
        {
            return GetHeightForRow(tableView, this.Element.Data[(int)indexPath.Item]);
        }
...
#endif
            {
                return onRowsInSection(tableView, (int)section);
            }
        }
