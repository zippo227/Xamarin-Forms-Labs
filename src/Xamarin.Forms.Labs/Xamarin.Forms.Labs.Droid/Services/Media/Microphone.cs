...
namespace Xamarin.Forms.Labs.Droid.Services.Media
{
	public class Microphone : IAudioStream
	{
		...
		public static bool IsEnabled
		{
			get
			{
				return AApplication.Context.PackageManager.HasSystemFeature (PackageManager.FeatureMicrophone) &&
					AApplication.Context.PackageManager.CheckPermission ("android.permission.RECORD_AUDIO", 
