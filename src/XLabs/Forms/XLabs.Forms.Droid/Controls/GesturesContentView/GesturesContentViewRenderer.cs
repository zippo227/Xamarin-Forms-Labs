...
using XLabs.Forms.Controls.GesturesContentView;
using Point = Xamarin.Forms.Point;
using View = Xamarin.Forms.View;

[assembly:ExportRenderer(typeof(Xamarin.Forms.Labs.Controls.GesturesContentView),typeof(GesturesContentViewRenderer))]

namespace XLabs.Forms.Controls.GesturesContentView
{
	/// <summary>
    ...
    public class GesturesContentViewRenderer  : ViewRenderer<GesturesContentView,Android.Views.View>  , GestureDetector.IOnGestureListener ,GestureDetector.IOnDoubleTapListener 
    {
        ...
        /// <summary>
        /// Pass the Fling(aka swipe) to the <see cref="Xamarin.Forms.Labs.Droid.Controls.GesturesContentView"/> for processing
        /// 
        /// </summary>
        /// <param name="e1"></param>
        /// <param name="e2"></param>
        ...
        /// <summary>
        /// Pass the longpress to the <see cref="Xamarin.Forms.Labs.Droid.Controls.GesturesContentView"/>
        /// </summary>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Send double tap to the <see cref="Xamarin.Forms.Labs.Droid.Controls.GesturesContentView"/> for processing
        /// </summary>
        /// <param name="e"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Send the Single tap to the <see cref="Xamarin.Forms.Labs.Droid.Controls.GesturesContentView"/> for processing
        /// </summary>
        /// <param name="e"></param>
        /// <returns></returns>
