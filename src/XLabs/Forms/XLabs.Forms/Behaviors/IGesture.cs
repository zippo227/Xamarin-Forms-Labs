...
namespace XLabs.Forms.Behaviors
{
	...
	{
		private readonly Action<GestureResult, object> _execute = null;
		private readonly Func<GestureResult,object,bool> _canexecute = null;
	...
	{
		private readonly Action<GestureResult, T> _execute = null;
		private readonly Func<GestureResult, T, bool> _canexecute = null;
