namespace XLabs.Platform.Droid.Device
{
	...
	using XLabs.Platform.Droid.Services.Media;
    ...
    public class AndroidDevice : IDevice
    {
        ...
        private AndroidDevice()
        {
            ...
            if (XLabs.Platform.Droid.Device.Accelerometer.IsSupported)
            {
                this.Accelerometer = new XLabs.Platform.Droid.Device.Accelerometer();
            }
            ...
            return Task.Run(() =>
                {
                    try
                    {
                        Xamarin.Forms.Context.StartActivity(new Android.Content.Intent("android.intent.action.VIEW", Android.Net.Uri.Parse(uri.ToString())));
                        return true;
                    }
