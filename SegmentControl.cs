/* Copyright 2014 Klickle LLC (www.klickle.com)
...
public class SegmentControl: ContentView { private StackLayout _layout;

    private Color _tintColor = Color.Black;
    public Color TintColor { get { return _tintColor; } 
